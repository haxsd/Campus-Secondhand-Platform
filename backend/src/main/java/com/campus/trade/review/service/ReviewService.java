...
@Service public class ReviewService {
 private final ReviewMapper reviewMapper; private final OrderMapper orderMapper; private final SellerDetailCacheInvalidator cacheInvalidator;
 public ReviewService(ReviewMapper reviewMapper, OrderMapper orderMapper, SellerDetailCacheInvalidator cacheInvalidator) { this.reviewMapper=reviewMapper; this.orderMapper=orderMapper; this.cacheInvalidator=cacheInvalidator; }
